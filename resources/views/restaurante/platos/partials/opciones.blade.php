...
<div class="card border-0 shadow-sm rounded-3 mt-4" id="opciones-container">
    <div class="card-body p-4">
        ...
        <p class="small text-muted mb-3">Ej: Tamaño (Individual / Familiar), Proteína (Pollo / Res), Extras (Con papas)</p>

        <div id="lista-opciones">
            @isset($plato)
                @foreach($plato->opciones as $oi => $opcion)
                <div class="opcion-item card border rounded-3 p-3 mb-3 bg-light">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="fw-bold small text-dark">Opción #<span class="num-opcion">{{ $oi + 1 }}</span></span>
                    ...
                    <div class="row g-2 mb-2">
                        <div class="col-12 col-sm-5">
                            <label class="form-label small fw-semibold">Nombre de la opción</label>
...
<template id="tpl-opcion">
    <div class="opcion-item card border rounded-3 p-3 mb-3 bg-light">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <span class="fw-bold small text-dark">Opción #<span class="num-opcion"></span></span>
            <button type="button" class="btn btn-sm btn-outline-danger rounded-pill px-2 btn-eliminar-opcion">
                <i class="bi bi-trash"></i>
            </button>
        </div>
