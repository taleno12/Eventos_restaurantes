<x-app-layout>
    ...
    <div class="container-fluid px-4 py-4" style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                <h1 class="h3 mb-0 fw-bold text-dark">
                    <i class="bi bi-person-plus-fill text-warning me-2"></i> Registrar Nuevo Trabajador
                </h1>
                <p class="text-muted small mb-0">Registra un nuevo trabajador y asígnale sus departamentos.</p>
            </div>
        </div>
        ...
        <form id="form-trabajador" action="{{ route('trabajadores.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="cargo" value="{{ old('cargo') }}" maxlength="100"
            ...
            <div class="card border-0 shadow-sm rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-4">
                        ...
                        Selecciona uno o más departamentos. Al marcarlos, se cargarán automáticamente los restaurantes disponibles.
                    </p>

                    <div class="row g-3 mb-4">
                        @foreach($departamentos as $depto)
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="form-check border rounded-3 p-3 bg-light depto-check-card" style="cursor:pointer; transition: border-color 0.2s;">
                                <input class="form-check-input depto-checkbox" type="checkbox"
                                       name="departamentos[]"
                                       value="{{ $depto->id }}"
                                       id="depto_{{ $depto->id }}"
                                       {{ in_array($depto->id, old('departamentos', [])) ? 'checked' : '' }}
                    ...
                    <div id="restaurantes-container" class="d-none">
                        ...
                        <div id="restaurantes-lista" class="row g-2">
                            {{-- Se llena via AJAX --}}
                        </div>
                    </div>

                    <div id="restaurantes-empty" class="d-none">
                    ...
                    <div id="restaurantes-loading" class="d-none">
                        <div class="d-flex align-items-center gap-2 text-muted small">
                            <span class="spinner-border spinner-border-sm text-warning"></span> Cargando restaurantes...
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 mb-4">
                <div class="card-body p-4">
                    ...
                    <textarea name="observaciones" rows="3"
                              ...
                              placeholder="Notas internas sobre el trabajador...">{{ old('observaciones') }}</textarea>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center justify-content-between mt-2 mb-4">
                ...
                <button type="submit" id="btn-submit"
                    ...
                    <i class="bi bi-check2-circle me-1"></i> Registrar Trabajador
                </button>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // ── AJAX: Cargar restaurantes al marcar/desmarcar departamentos ──
        ...
        const emptyMsg           = document.getElementById('restaurantes-empty');
        const loadingMsg         = document.getElementById('restaurantes-loading');
        ...
        function cargarRestaurantes() {
            ...
            fetch('{{ route("trabajadores.restaurantes.por.departamentos") }}', {
                method: 'POST',
                headers: {
        ...
        checkboxes.forEach(cb => cb.addEventListener('change', cargarRestaurantes));

        // Cargar si hay old() seleccionados (errores de validación)
        if (getDeptoSeleccionados().length > 0) cargarRestaurantes();
