...
<div class="container-fluid px-4 py-4" style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0 small">
                ...
                Gestión de accesos, roles y permisos en la plataforma Gastro.ni
            </p>
        </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-6 col-sm-4 col-lg-2">
            <div class="card border-0 shadow-sm rounded-3 p-3 bg-white h-100">
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-3 d-flex align-items-center justify-content-center bg-warning bg-opacity-10 p-2 fs-5" style="width:44px;height:44px;">
                        <i class="bi bi-people-fill text-warning"></i>
                    </div>
                    <div>
                        <p class="text-uppercase text-muted fw-bold mb-0" style="font-size:0.7rem;letter-spacing:0.5px;">Total</p>
        ...
        <div class="col-6 col-sm-4 col-lg-2">
            <div class="card border-0 shadow-sm rounded-3 p-3 bg-white h-100">
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-3 d-flex align-items-center justify-content-center bg-danger bg-opacity-10 p-2 fs-5" style="width:44px;height:44px;">
        ...
        <div class="col-6 col-sm-4 col-lg-2">
            <div class="card border-0 shadow-sm rounded-3 p-3 bg-white h-100">
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-3 d-flex align-items-center justify-content-center bg-primary bg-opacity-10 p-2 fs-5" style="width:44px;height:44px;">
        ...
        <div class="col-6 col-sm-4 col-lg-2">
            <div class="card border-0 shadow-sm rounded-3 p-3 bg-white h-100">
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-3 d-flex align-items-center justify-content-center bg-success bg-opacity-10 p-2 fs-5" style="width:44px;height:44px;">
        ...
        <div class="col-6 col-sm-4 col-lg-2">
            <div class="card border-0 shadow-sm rounded-3 p-3 bg-white h-100">
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-3 d-flex align-items-center justify-content-center bg-info bg-opacity-10 p-2 fs-5" style="width:44px;height:44px;">
                        <i class="bi bi-person-heart text-info"></i>
                    </div>
                    <div>
                        <p class="text-uppercase text-muted fw-bold mb-0" style="font-size:0.7rem;letter-spacing:0.5px;">Clientes</p>
                        <h3 class="fw-black text-dark mb-0" style="font-size:1.4rem;">{{ $totalClientes }}</h3>
                    </div>
                </div>
            </div>
        </div>

        {{-- ── Registros Hoy: amarillo solo si hay registros, blanco si no ── --}}
        <div class="col-6 col-sm-4 col-lg-2">
            @if($totalHoy > 0)
                <div class="card shadow-sm rounded-3 p-3 h-100" style="background:#fff8e1; border:1px dashed #ffc107 !important;">
                    <div class="d-flex align-items-center gap-3">
                        <div class="rounded-3 d-flex align-items-center justify-content-center bg-warning bg-opacity-20 p-2 fs-5" style="width:44px;height:44px;">
                            <i class="bi bi-graph-up-arrow text-warning"></i>
                        </div>
                        <div>
                            <p class="text-uppercase text-muted fw-bold mb-0" style="font-size:0.7rem;letter-spacing:0.5px;">Registros hoy</p>
                            <h3 class="fw-black text-dark mb-0" style="font-size:1.4rem;">{{ $totalHoy }}</h3>
                        </div>
                    </div>
                </div>
            @else
                <div class="card border-0 shadow-sm rounded-3 p-3 bg-white h-100">
                    <div class="d-flex align-items-center gap-3">
                        <div class="rounded-3 d-flex align-items-center justify-content-center bg-secondary bg-opacity-10 p-2 fs-5" style="width:44px;height:44px;">
        ...
        <form method="GET" action="{{ route('usuarios.index') }}" class="row g-3 align-items-center">
            ...
            <div class="col-12 col-sm-3">
                <div class="input-group">
                    ...
                    <select name="role" class="form-select bg-light border-start-0 ps-0" style="box-shadow:none;cursor:pointer;">
                        <option value="">Todos los roles</option>
                        <option value="admin"        {{ request('role') == 'admin'        ? 'selected' : '' }}>Administrador</option>
                        <option value="restaurante"  {{ request('role') == 'restaurante'  ? 'selected' : '' }}>Restaurante</option>
                        <option value="gastrobar"    {{ request('role') == 'gastrobar'    ? 'selected' : '' }}>Gastrobar</option>
                        <option value="usuario"      {{ request('role') == 'usuario'      ? 'selected' : '' }}>Cliente</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-3 d-flex gap-2">
                ...
                @if(request('search') || request('role') || request('estado'))
                    ...
                    <tbody class="border-top-0">
                        ...
                        <tr class="border-bottom" style="border-color:#edf2f7 !important;">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="rounded-3 border overflow-hidden bg-light d-flex align-items-center justify-content-center me-2 shadow-sm" style="width:40px;height:40px;flex-shrink:0;">
                                        ...
                                        @else
                                            ...
                                            @endphp
                                            <span class="fw-bold" style="font-size:0.75rem;color:{{ $c['color'] }};background:{{ $c['bg'] }};width:100%;height:100%;display:flex;align-items:center;justify-content:center;">
                                                {{ $iniciales }}
                                            </span>
                                        @endif
                                    </div>
                            ...
                            <td class="py-3">
                                ...
                                @endphp
                                <span class="badge px-2 py-1 fw-bold text-uppercase d-inline-flex align-items-center gap-1"
                                      style="background:{{ $rc['bg'] }};color:{{ $rc['color'] }};font-size:0.7rem;letter-spacing:0.3px;">
                            ...
                            <td class="py-3">
                                @if(!empty($usuario->telefono))
                                    <span class="text-dark small">
                                        <i class="bi bi-telephone text-muted me-1" style="font-size:0.75rem;"></i>
                                        {{ $usuario->telefono }}
                                    </span>
                                @else
                            ...
                            <td class="text-end pe-4 py-3">
                                <div class="d-flex justify-content-end align-items-center gap-2">
                                    ...
                                    <a href="{{ route('usuarios.edit', $usuario->id) }}"
                                       class="text-secondary p-1 action-icon-edit" title="Editar usuario">
                                    ...
                                    <form action="{{ route('usuarios.toggle', $usuario->id) }}" method="POST" class="d-inline m-0">
                                        ...
                                        @method('PATCH')
                                        <button type="submit"
                                                class="btn btn-link p-1 m-0 border-0 align-baseline action-icon-toggle"
                                                title="{{ ($usuario->estado ?? 'activo') === 'activo' ? 'Suspender' : 'Activar' }}"
                        ...
                        <tr>
                            <td colspan="6" class="text-center text-muted py-5">
                                ...
                                <span class="fs-6 d-block mb-2">No se encontraron usuarios registrados.</span>
                                <a href="{{ route('usuarios.create') }}" class="btn btn-sm btn-warning rounded-pill px-3 fw-semibold text-dark">
