...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex align-items-center gap-2 mb-4">
        <a href="{{ route('gastrobar.solicitudes.index', $solicitud->empleo) }}"
    ...
    <div class="panel-card">
        <div class="card-body p-4">
            ...
            <div class="d-flex align-items-start justify-content-between mb-4 flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0"
                         style="width:60px;height:60px;background:rgba(var(--primary-rgb,99,102,241),0.12);">
                ...
                <div class="col-md-6">
                    ...
                    @else
                        <a href="mailto:{{ $solicitud->email }}" class="text-decoration-none fw-semibold" style="color:var(--text);">
                            <i class="bi bi-envelope-fill me-1" style="color:var(--primary);"></i>{{ $solicitud->email }}
                        </a>
                    @endif
                </div>
                <div class="col-md-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        @foreach($solicitud->disponibilidad as $d)
                            <span class="badge rounded-pill px-3 py-2" style="background:rgba(var(--primary-rgb,99,102,241),0.12);color:var(--primary);">
            ...
            <div class="d-flex gap-2 border-top pt-3" style="border-color:var(--card-border) !important;">
                <form action="{{ route('gastrobar.solicitudes.estado', $solicitud) }}" method="POST" class="d-flex gap-2">
                    @csrf
                    @method('PATCH')
                ...
                <form action="{{ route('gastrobar.solicitudes.destroy', $solicitud) }}" method="POST"
