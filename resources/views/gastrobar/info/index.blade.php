    ...
    @php
        $secciones = [
            ...
            [
                ...
                'titulo' => 'Mis Eventos',
                'texto' => 'Crea y administra los eventos de tu gastrobar (promociones, noches especiales, festivales). Cada evento necesita: título, descripción, precio, fecha, ubicación e imagen principal. Puedes agregar fotos adicionales a una galería del evento. Los eventos publicados desde aquí son "normales" — los eventos destacados del banner principal son gestionados por nuestro equipo.'
            ],
            [
                'icono' => 'bi-briefcase-fill', 'color' => 'purple',
                'titulo' => 'Mis Empleos',
                'texto' => 'Publica ofertas de trabajo para tu gastrobar. Incluye título del puesto, descripción, requisitos, tipo de contrato, salario (opcional) y fecha límite. Puedes activar o desactivar una oferta sin eliminarla — las inactivas no se muestran a los candidatos.'
            ],
            [
                'icono' => 'bi-egg-fried', 'color' => 'green',
                'titulo' => 'Menú',
                'texto' => 'Aquí construyes el menú digital de tu gastrobar. Cada plato tiene nombre, descripción, precio, categoría (Entradas, Platos fuertes, Bebidas, etc.) y foto. Puedes activar/desactivar platos según disponibilidad. Los platos activos aparecen en tu página pública para que los clientes hagan pedidos.'
            ],
            [
            ...
            [
                ...
                'titulo' => 'Mi Perfil',
                'texto' => 'Edita la información pública de tu gastrobar: nombre, especialidad, descripción, ubicación (departamento, municipio, dirección y coordenadas GPS), teléfono, WhatsApp, redes sociales y foto de portada. Esta información es la que ven los usuarios en tu página.'
            ],
        ];
    @endphp
            ...
            @php
                $terminos = [
                    [
                        ...
                        'texto' => 'Al registrarte y utilizar el Panel del Gastrobar de GastroNicaragua, aceptas cumplir con estos términos y condiciones. Si no estás de acuerdo, debes abstenerte de utilizar la plataforma.'
                    ],
                    [
                    ...
                    [
                        ...
                        'texto' => 'El gastrobar es responsable de la veracidad de la información publicada (eventos, empleos, menú, fotos, precios y datos de contacto). GastroNicaragua se reserva el derecho de remover contenido que sea falso, ofensivo, ilegal o que infrinja derechos de terceros, sin previo aviso.'
                    ],
                    [
                        'titulo' => '4. Eventos destacados',
                        'texto' => 'Los eventos publicados desde el panel del gastrobar se consideran "eventos normales". La promoción de eventos en el banner principal (eventos destacados) es gestionada exclusivamente por el equipo administrativo de GastroNicaragua y puede estar sujeta a criterios adicionales o costos asociados, los cuales se comunicarán por separado.'
                    ],
                    [
                        'titulo' => '5. Pedidos y menú digital',
                        'texto' => 'Los precios y disponibilidad de los platos publicados en el menú digital son responsabilidad exclusiva del gastrobar. GastroNicaragua actúa únicamente como intermediario tecnológico que conecta al cliente con el gastrobar; no participa en la preparación, calidad o entrega de los alimentos, ni en disputas relacionadas con pagos realizados directamente entre cliente y gastrobar.'
                    ],
                    [
                        'titulo' => '6. Imágenes y propiedad intelectual',
                        'texto' => 'El gastrobar garantiza tener los derechos necesarios sobre las imágenes y contenido que sube a la plataforma (fotos de platos, portada, galería). GastroNicaragua no se hace responsable por reclamos de terceros relacionados con derechos de autor sobre contenido subido por el gastrobar.'
                    ],
                    [
                        'titulo' => '7. Reseñas de clientes',
                        'texto' => 'Las reseñas son opiniones de usuarios reales y reflejan su experiencia personal. GastroNicaragua no modifica ni elimina reseñas a solicitud del gastrobar, salvo en casos de contenido que viole nuestras políticas de comunidad (lenguaje ofensivo, información falsa comprobable, spam).'
                    ],
                    [
    ...
    @php
        $faqs = [
            ...
            [
                ...
                'a' => 'Por diseño, los gastrobares solo pueden publicar eventos "normales". Esto asegura que el banner principal mantenga calidad y orden, coordinado directamente por el equipo de GastroNicaragua.'
            ],
            [
