                    ...
                    <div class="card-body p-4 d-flex flex-column gap-3">
                        ...
                        <div>
                            ...
                            <textarea name="descripcion" class="form-control" rows="4"
                                      ...
                                      style="background:#0f172a;border-color:#475569;color:#f8fafc;">{{ old('descripcion', $evento->descripcion) }}</textarea>
                        </div>
                        <div class="row g-3">
                            <div class="col-6">
                ...
                <div class="card border-0 shadow-sm rounded-3" style="background:#1e293b;">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <div style="position:relative;width:80px;height:80px;border-radius:10px;overflow:hidden;border:1px solid #475569;">
                ...
                <div class="card border-0 shadow-sm rounded-3" style="background:#1e293b;">
                    ...
                    <div class="card-body p-4">
                        <div class="border rounded-3 p-4 text-center position-relative galeria-drop"
                             style="border-style:dashed !important;border-color:#475569;cursor:pointer;transition:border-color 0.2s;background:#0f172a;">
                            <i class="bi bi-images d-block mb-2 fs-4" style="color:#94a3b8;"></i>
                            <p class="small mb-1" style="color:#cbd5e1;">Arrastra fotos aquí o <span class="fw-semibold" style="color:#818cf8;">haz clic para seleccionar</span></p>
            ...
            <div class="col-12 col-lg-4 d-flex flex-column gap-4">
                ...
                <div class="card border-0 shadow-sm rounded-3" style="background:#1e293b;">
                    ...
                    <div class="card-body p-4 d-flex flex-column gap-3">
                        @if($evento->imagen)
                        <div>
                            <p class="fw-bold mb-2" style="font-size:11px;text-transform:uppercase;letter-spacing:0.08em;color:#94a3b8;">Imagen actual</p>
                            <img src="{{ asset('storage/'.$evento->imagen) }}"
                                 class="w-100 rounded-3 border"
                                 style="object-fit:cover;aspect-ratio:16/9;border-color:#475569 !important;">
                        </div>
                        @endif
                        ...
                        <div id="imagen-drop" class="border rounded-3 position-relative d-flex align-items-center justify-content-center flex-column gap-2"
                             style="border-style:dashed !important;border-color:#475569;aspect-ratio:16/9;cursor:pointer;overflow:hidden;transition:border-color 0.2s;background:#0f172a;">
                            ...
                            <div id="imagen-placeholder" class="text-center px-3">
                                <i class="bi bi-cloud-upload d-block mb-2 fs-4" style="color:#94a3b8;"></i>
                                <p class="small mb-0" style="color:#cbd5e1;">{{ $evento->imagen ? 'Cambiar imagen' : 'Subir imagen' }}</p>
                            </div>
                            <input type="file" name="imagen" id="imagen-input" accept="image/*"
                                   style="position:absolute;inset:0;opacity:0;cursor:pointer;">
                        </div>
                        <p class="mb-0" style="font-size:11px;color:#94a3b8;">Deja vacío para mantener la imagen actual</p>
                    </div>
                </div>
