...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .nav-link.active { color: #1d4ed8; background: var(--primary-light); }
        .nav-link.active i { background: #bfdbfe; color: var(--primary); }
        ...
        .metric-icon.orange { background: #eff6ff; color: var(--primary); }
        ...
        .btn-primary-panel:hover { background: #1d4ed8; color: white; box-shadow: 0 4px 14px rgba(37, 99, 235, 0.35); }

        .btn-secondary-panel {
            background: white; color: #5a6175; border: 1px solid var(--card-border);
        ...
        .form-control, .form-select {
            background: #fafbfc !important; border: 1px solid #e2e5ec !important;
            color: var(--text) !important; border-radius: 10px !important;
            font-size: 13.5px !important; font-family: inherit !important; padding: 9px 14px !important;
        }
        ...
        .panel-table th {
            ...
            color: var(--muted); padding: 10px 16px; border-bottom: 1px solid var(--card-border);
            text-align: left; background: #fafbfc;
        }

        .panel-table td {
            padding: 13px 16px; border-bottom: 1px solid #f0f1f4;
        ...
        .badge-orange { background: #eff6ff; color: #1d4ed8; border: 1px solid #bfdbfe; }
        ...
        .action-btn-edit:hover    { color: #2563eb; background: #eff6ff; border-color: #bfdbfe; }
...
<body>
    ...
    <div class="topbar">
        ...
        <div class="d-flex align-items-center gap-2">
            <div style="width:28px;height:28px;background:linear-gradient(135deg,#2563eb,#1d4ed8);border-radius:8px;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px rgba(37,99,235,.3)">
