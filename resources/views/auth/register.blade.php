<x-guest-layout>
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-login:hover { border-color: #FF5500; color: #FF5500; }
    ...
    <div class="reg-root">
        ...
        <div class="panel-left">
            ...
            <div class="lp-hero">
                ...
                <p class="hs">
                    Regístrate y accede a los mejores restaurantes, platillos
                    y experiencias culinarias de Nicaragua desde donde estés.
                </p>
            </div>
        ...
        <div class="panel-right">
            <div class="right-inner">
                ...
                <a href="{{ route('login') }}" class="btn-login fu d8">¿Ya tienes cuenta? Iniciar sesión</a>
    ...
    <script>
        ...
        function checkStrength(v) {
            ...
            const colors = ['#FF2200', '#FF5500', '#FFAA00', '#22CC66'];
