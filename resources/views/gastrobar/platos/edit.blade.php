...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="mb-0 small" style="color:var(--muted);">{{ $plato->nombre }}</p>
        </div>
    ...
    @if($errors->any())
        <div class="alert alert-danger alert-dismissible fade show border-0 shadow-sm mb-4" role="alert"
             style="background:rgba(239,68,68,0.1);border:1px solid rgba(239,68,68,0.2) !important;color:#ef4444;">
    ...
    <form method="POST" action="{{ route('gastrobar.platos.update', $plato) }}" enctype="multipart/form-data">
        @csrf @method('PUT')
                ...
                <div class="card border-0 shadow-sm rounded-3" style="background:var(--card-bg) !important;">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="descripcion" class="form-control" rows="3">{{ old('descripcion', $plato->descripcion) }}</textarea>
                        </div>
            ...
            <div class="col-12 col-lg-4 d-flex flex-column gap-4">
                ...
                <div class="card border-0 shadow-sm rounded-3" style="background:var(--card-bg) !important;">
                    <div class="card-body p-4">
                        ...
                        @endif
                        <label for="imagen-input" class="w-100" style="cursor:pointer;">
                            <div class="rounded-3 d-flex flex-column align-items-center justify-content-center position-relative overflow-hidden"
                                 style="aspect-ratio:1;border:2px dashed var(--input-border);cursor:pointer;background:var(--input-bg);">
                ...
                <div class="card border-0 shadow-sm rounded-3" style="background:var(--card-bg) !important;">
                    <div class="card-body p-4">
                        ...
                        <a href="{{ route('gastrobar.platos.index') }}"
                           ...
                           style="background:var(--hover-bg);color:var(--text);border-color:var(--card-border);">
                            Cancelar
                        </a>
                    </div>
                </div>
    ...
    <form id="form-delete-plato" method="POST"
          action="{{ route('gastrobar.platos.destroy', $plato) }}" style="display:none;">
        @csrf @method('DELETE')
    </form>
