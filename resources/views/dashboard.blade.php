...
@section('content')
<div class="max-w-7xl mx-auto px-6 py-10 animate-fade-in" style="font-family: 'Segoe UI', Roboto, sans-serif;">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6">
        <div>
            ...
            <h1 class="text-4xl font-black text-slate-900 tracking-tight leading-none">Panel Central</h1>
            <p class="text-slate-500 font-medium mt-2 text-base">Analíticas de rendimiento para <span class="text-indigo-600 font-bold">Gastro.ni</span></p>
        </div>
        
        <div class="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 flex items-center gap-4 self-start md:self-auto">
    ...
    {{-- Estadísticas Organizadas en 3 Columnas (Grid Moderno) --}}
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        
        <div class="group bg-white rounded-3xl border border-slate-100 p-6 shadow-sm hover:shadow-md hover:border-indigo-100 transition-all duration-300 relative overflow-hidden flex flex-col justify-between min-h-[160px]">
            <div class="flex justify-between items-start">
                ...
                <div class="bg-slate-50 p-4 rounded-2xl text-slate-700 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300 shadow-inner">
        ...
        <div class="group bg-white rounded-3xl border border-slate-100 p-6 shadow-sm hover:shadow-md hover:border-emerald-100 transition-all duration-300 relative overflow-hidden flex flex-col justify-between min-h-[160px]">
            <div class="flex justify-between items-start">
                <div class="space-y-2">
                ...
                <div class="bg-slate-50 p-4 rounded-2xl text-slate-700 group-hover:bg-emerald-500 group-hover:text-white transition-all duration-300 shadow-inner">
        ...
        <div class="group bg-white rounded-3xl border border-slate-100 p-6 shadow-sm hover:shadow-md hover:border-amber-100 transition-all duration-300 relative overflow-hidden flex flex-col justify-between min-h-[160px]">
            <div class="flex justify-between items-start">
                <div class="space-y-2">
                ...
                <div class="bg-slate-50 p-4 rounded-2xl text-slate-700 group-hover:bg-amber-500 group-hover:text-white transition-all duration-300 shadow-inner">
    ...
    <div class="relative group">
        ...
        <div class="relative bg-slate-900 rounded-3xl p-10 overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
            
            <div class="absolute top-0 right-0 p-4 pointer-events-none opacity-5">
                <i class="fas fa-rocket text-[12rem] -rotate-12 translate-x-10 translate-y-10 text-white"></i>
            </div>
            
            <div class="relative z-10 text-center md:text-left">
                <h4 class="text-2xl font-black text-white tracking-tight">Centro de Operaciones</h4>
